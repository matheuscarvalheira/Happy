// create map
const map = L.map("mapid").setView([-27.2252621, -49.6488005], 15);
...
function addPhotoField() {
  ...
  //realizar o clone / duplicação  da última imagem adcionada
...
function toggleSelect(event) {
  ...
  //att meu input hidden com o valor selecionado
